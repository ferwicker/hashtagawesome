const optionsObject:{[key:string]: string[]} = {
    ...
    coloursAll: ['black', 'white', 'cream', 'nude', 'pastel pink', 'pink', 'light pink', 'hot pink', 'neon pink', 'magenta', 'fucsia', 'wine red', 
        ...
        'purple', 'lilac', 'light purple', 'plum', 'mauve', 'olive green'],
    coloursSpring: ['nude', 'pink', 'yellow', 'pastel yellow', 'pastel pink', 'pastel blue', 'mint green', 
        'lime green', 'orange', 'lilac', 'pastel orange', 'sky blue', 'aqua', 'peach'],
    coloursSummer: ['nude', 'orange', 'yellow', 'hot pink', 'pink', 'sky blue', 'royal blue', 'turquoise', 'neon green', 'neon yellow',
        'neon pink', 'neon orange', 'light orange', 'lime green', 'purple', 'green', 'lilac'],
    ...
    artAll: ['mushrooms', 'flowers', 'swirls', 'abstract', 'geometric', 'animals', 'french tip', 'botanical', 'snakes', 'clouds', 
        ...
        'smilies', 'ying yang', 'gradient', 'flames', 'rainbow', 'marble', 'aliens'],
    artSpring: ['floral', 'botanical', 'bees', 'clouds', 'abstract', 'swirls', 'animals', 'french tip', 'gradient', 'rainbow', 'marble'],
    artSummer: ['swirls', 'fruits', 'mix&match', 'ying yang', 'smilies', 'french tip', 'checkers', 'gradient', 'flames', 'marble'],
    artAutumn: ['leaves', 'abstract', 'swirls', 'animals', 'french tip', 'gradient', 'marble'],
    artWinter: ['snow', 'abstract', 'swirls', 'animals', 'french tip', 'gradient', 'marble'],
